...
from app.modules.devices.mercury230.accounting_sheet.service import AccountingSheetReportService
from app.models.accounting_period_types import AccountingPeriodTypes

router = APIRouter()


@router.get("/device/mercury230/accounting-sheets")
async def get_accounting_sheet_report_async(
