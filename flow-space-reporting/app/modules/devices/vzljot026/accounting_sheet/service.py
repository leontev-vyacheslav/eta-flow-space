...
from app.modules.devices.vzljot026.accounting_sheet.repository import AccountingSheetRepository
...
class AccountingSheetReportService(AccountingSheetReportBaseService):
    ...
    def __init__(self, repository: Annotated[AccountingSheetRepository, Depends(AccountingSheetRepository)]):
        self.templates_dir = Path(__file__).parent.parent.parent.parent.parent / "templates/devices/vzljot026"
