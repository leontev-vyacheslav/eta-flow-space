const deviceState = {
    ...
    sourceWaterPumps: [
        {
            // enums (SourceWaterPumpState): "Нет питания"=1, "Остановлен"=2, "В работе"=4, "Авария"=8, "Запуск (разгон)"=16, "Останов"=32, "Регулирование (мин. частота)"=128, "Регулирование (макс. частота)"=256, "Ожидание включения"=512, "Ожидание готовности"=1024
            state: 2 // Состояние насоса исходной воды
        }
